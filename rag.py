...
prompt_template = """
Use the following financial information to provide accurate responses to the user's questions. Please refrain from speculation or providing false information.

Context: {context}
Question: {question}

Provide a concise and accurate answer based on the financial context.
...
db = Qdrant(client=client, embeddings=embeddings, collection_name="finacial_db")
...
# # local_llm = AutoModelForCausalLM.from_pretrained("BioMistral/BioMistral-7B")
